...
<title>Building my first Phonegap iOS app and what I learned</title>
...
<MdxLayout>
    ...
    <div className="my-10 flex items-center justify-center">
        <img className="h-[500px]" alt="MideoMe on iOS" src={mideomeDiscover.src} />
    </div>
    ...
    <div className="my-10 flex items-center justify-center">
        <img className="h-[300px]" alt="managing log ins" src={currentLogInsImage.src} />
    </div>
    ...
    <div className="my-10 flex items-center justify-center">
        <img className="h-[600px] my-2" alt="MideoMe in the iOS app store" src={onTheAppStoreImage.src} />
    </div>
