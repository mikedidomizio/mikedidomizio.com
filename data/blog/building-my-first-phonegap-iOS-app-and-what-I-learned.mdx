...
<div className="my-10 flex items-center justify-center">
    <img className="sm:w-6/6 md:h-[600px]" alt="MideoMe on iOS" src="/mideome-discover-new-people.jpeg" />
</div>
...
<div className="my-10 flex items-center justify-center">
    <img className="w-6/6 sm:w-6/6" alt="managing log ins" src="/managing-log-ins.png" />
</div>
...
<div className="my-10 flex items-center justify-center">
    <img className="w-6/6 sm:w-6/6" alt="MideoMe in the iOS app store" src="/mideome-in-the-app-store.png" />
</div>
