...
date: '2024-01-16'
tags: ['content security policy', 'csp', 'next.js', 'vercel', 'vercel.json', 'vue.js']
draft: true
---
...
- [Introduction](#intro)
- [Blog Shutdown](#the-blog-shutdown)
- [Move to AWS S3](#the-move-to-aws-s3)
- [Busy in 2023](#busy-in-2023)
- [The Issues](#the-issues)
  - [Creating the Vercel Configuration](#creating-the-verceljson-configuration)
...
It did take understanding what had to be done to get it to work right but once understood it worked nicely 🎉.

Have you done a similar setup? I'm curious. <TweetIntent text="Let me know!" tweet="@Mike_DiDomizio re:deploying multi apps under via Vercel." />
