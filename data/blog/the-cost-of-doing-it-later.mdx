...
in my tests, I know how the code is expected to function today. Tests
...
Do you not take on some liability? I know it's an extreme comparison, and maybe no one is dying because the HTML button is not clickable, but it take two seconds to ask yourself what the cost is if we don't add tests.
