...
Depending on how long those tests are missing, we put the next person in a vulnerable spot if tests aren't added now. How are they expected to know about a certain code's functionality?
 ...
 - Are you going to dig through many years of tracked issues to determine what the expectations were at that time? What if the issues were poorly documented? What if those expectations changed since the initial tracked issue? What if some changes weren't tracked? What if those people who know no more are no longer around?
...
4. Team morale—It can be worrying to work on a code base that has shaky legs, or one you can visually witness slowly becoming more brittle due to testing coverage/quality suffering. Do you want to work on a code base with large gaps in testing? Do you enjoy playing whack-a-mole with bugs?
5. Maintenance, tech debt - As a code base evolves and becomes more complex, testing keeps us in line. How can anyone confidently refactor without proper testing? Refactoring code that's existed without tests for years can result in a high chance of introducing bugs.
...
Don't become a victim to code review peer pressure “I need this in today”. Rushing things in is usually a recipe for disaster.
