...
- Get sick
- Injury
- A loved one die / bereavement period
- Change teams
- Team dissolves
- Change companies
- Die

We can try and squeeze something into the next sprint planning, roadmaps, backlog/tech debt items, but the truth is life in unpredictable and can throw us curveballs.
Understand that the opportunity to right things may never come.

It happens more than you think.

Whenever I'm hit with “I'll do it later”, it irks me a bit; because I've seen many occurrences where doing it later never ends up happening.
By postponing tests, you leave things vulnerable.
...
1. Code quality assurance
    ...
    - I don't have to worry about another person coming in and breaking things between now and then. What if a code change on top of yours introduces a regression and it all makes it into production, “why didn't you add tests”?
...
head wondering how the hell the tree was supposed to be planted.  The right time to write tests is right now.
